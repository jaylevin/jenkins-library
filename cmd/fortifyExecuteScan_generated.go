...
func addFortifyExecuteScanFlags(cmd *cobra.Command, stepConfig *fortifyExecuteScanOptions) {
	...
	cmd.Flags().StringVar(&stepConfig.AuthEntityIds, "authEntityIds", os.Getenv("PIPER_authEntityIds"), "A comma separated list of AuthEntity IDs to append to the project version if they do not already exist.")
